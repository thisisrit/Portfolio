...
const projectsData: Project[] = [
  {
    title: "Portfolio",
    description: "A Portfolio which is minimal with all the necessary things.",
    link: "/",
  ...
  {
    title: "Fizzi - Soda for all",
    description: "A frontend website that is desgined for a soda company.",
    link: "https://fizzi-rit.vercel.app/",
    code: "https://github.com/thisisrit/fizzi-rit",
    previewVideo: "/videos/FizziPreview.mp4",
          ...
          >
            ...
            <div className="flex flex-col gap-3 p-4 grow">
              ...
              <div className="flex gap-2 mt-auto">
                <Link
                  href={item.link}
                  target={item.title === "Portfolio" ? "_self" : "_blank"}
                >
